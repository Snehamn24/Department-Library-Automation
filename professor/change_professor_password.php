...
<body>
   <!-- Navbar -->
    ...
    <marquee>Department Library Automation. Library opens at 10:00 AM and closes at 4:00 PM</marquee>
         <div class="row">
        <div class="col-md-4"></div>
        <div class="col-md-4">
            <form action="update_professor_password.php" method="post" onsubmit="return validateFunction();">
