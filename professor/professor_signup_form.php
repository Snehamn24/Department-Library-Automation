...
<body>
    <nav class="navbar navbar-expand-lg custom-navbar">
        <div class="container-fluid">
            ...
            &nbsp;&nbsp; 
            <a class="navbar-brand" href="../admin/admin_dashboard.php">Department Library Automation</a>
    ...
    <div class="d-flex justify-content-center align-items-center" style="min-height: calc(100vh - 80px); padding: 20px;">
        <div class="col-md-10 p-4 rounded d-flex align-items-center" style="background-color: #ffffff; border: 2px solid #ffffff; box-shadow: 0 0 20px rgba(0,0,0,0.1);">
            ...
            <div class="col-md-5 text-center" style="background-color: white;">
                <img src="../teacher2.png" alt="Registration Icon" class="img-fluid" style="max-height: 500px;max-width: 500px;">
            </div>

            <!-- Right side: Form -->
            <div class="col-md-7 ps-4" style="background-color: white;">
                <h3>
                    <img src="../sign_int.png" alt="icon" style="height: 31px; width: 30px; margin-right: 10px;">
                    Professor Registration Form
                </h3>
                <form action="professor_register_btn.php" method="post" onsubmit="return validateFunction();">
                    ...
                    <div class="d-flex gap-3">
                       ...
                       <!-- <a class="logo1" href="professor_login.php">Login</a>-->
                    </div>
                </form>
            </div>
        </div>
