...
<body>
    ...
    <span><marquee>This is Department Library Automation System. Library opens at 8:00 AM and closes at 8:00 PM</marquee></span><br><br>
    <div class="row">
        ...
        <div class="col-md-4">
            <form action="update.php" method="post" onsubmit="return validateFunction();">
                <div class="form-group mb-3">
                    ...
                    <input type="text" id="name" class="form-control" value="<?php echo $name;?>" name="name"> 
                </div>
                <div class="form-group mb-3">
                    <label for="uucms">UUCMS-ID:</label>
                    <input type="text" id="uucms" class="form-control" value="<?php echo $uucms;?>" name="uucms"> 
                </div>
                ...
                <div class="form-group mb-3">
                  ...
                  <textarea rows="3" cols="40" name="address" id="address" class="form-control"><?php echo $address;?></textarea>
                </div>
 ...
 <script type="text/javascript">
        ...
        function validateFunction() {
            ...
            if (!addressRegx.test(address)) {
                alert("Invalid address..Adddress should have minimum 5 characters");
                document.getElementById("address").value = "";
                return false;
            }

            var uucms = document.getElementById("uucms").value;
           var uucmsRegex = /^[A-Za-z0-9]+$/;

          if (!uucmsRegex.test(uucms)) {
          alert("UUCMS ID should contain only alphabets and numbers.");
         document.getElementById("uucms").value = "";
        return false;
}
