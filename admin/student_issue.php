...
// SQL Query
$query =   "SELECT student_id , student_name , book_num , book_name , issue_date, return_date , status from stu_issue_book";
...
&nbsp;&nbsp; 
  ...
  <div class="sidebar" id="sidebar">
    ...
    <div class="container mt-4">
        <h2 class="text-center">Department Issued Books to Students</h2>
