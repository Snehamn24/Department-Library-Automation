        ...
        <div class="col-md-8">
            <table class="table table-bordered table-hover">
                ...
                while($row=mysqli_fetch_assoc($query_run)){
                    ...
                    <td><button class="btn" name=""> <a href="edit_category.php?cat_id=<?php echo $row['cat_id'];?>">Edit</a></button>
                        <button class="btn" name=""> <a href="delete_category.php?cat_id=<?php echo $row['cat_id'];?>">Delete</a></button>
                    </td>
                </tr>
