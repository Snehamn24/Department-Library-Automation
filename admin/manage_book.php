                ...
                while($row=mysqli_fetch_assoc($query_run)){
                  ...
                  <td><img src="<?php echo $imageUrl; ?>" alt="<?php echo $row['book_name']; ?>" width="80px" height="100px"></td>
                   <td><?php echo $row['book_name'];?></td>
                    ...
                    <td><button class="btn" name=""> <a href="edit_book.php?bn=<?php echo $row['book_isbn'] ;?>">Edit</a></button>
                        <button class="btn" name=""> <a href="delete_book.php?bn=<?php echo $row['book_isbn'] ;?>">Delete</a></button>
                    </td>
                </tr>
