...
<head>
    ...
    overflow: hidden; /* optional, can be 'visible' */
    display: flex;
    flex-wrap: wrap;
}
...
<nav class="navbar navbar-expand-lg custom-navbar">
  <div class="container-fluid">
    <img src="../booklogo.png" alt="admin" class="img-fluid" style="height: 50px; width: 50px;"> 
    &nbsp;&nbsp; 
...
<div id="card-home">
  <div class="card-left">
    <img src="../admin.png" alt="Student Illustration">
  </div>

  <div class="card-right">
    <center class="logo"><h3>Admin Login Form</h3></center>
