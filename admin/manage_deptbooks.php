        ...
        <div class="col-md-8">
            <table class="table table-bordered table-hover">
                ...
                while($row=mysqli_fetch_assoc($query_run)){
                    ...
                    ?>
                    <tr>
                  <td><img src="<?php echo $imageUrl; ?>" alt="<?php echo $row['book_name']; ?>" width="80px" height="100px"></td>
                   ...
                   <td><?php echo $row['book_name'];?></td>
                    ...
                    <td><?php echo $row['no_copy'];?></td>
                    <td><button class="btn" name=""> <a href="edit_deptbook.php?bn=<?php echo $row['book_isbn'] ;?>">Edit</a></button>
                        <button class="btn" name=""> <a href="delete_deptbook.php?bn=<?php echo $row['book_isbn'] ;?>">Delete</a></button>
                    </td>
                </tr>
