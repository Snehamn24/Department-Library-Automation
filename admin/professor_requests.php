...
// SQL Query
$query =   "SELECT professor_id,professor_name,book_num,book_name,status from pro_book_requests";
                    ...
                    while ($row = mysqli_fetch_assoc($query_run)) {
                        ...
                        <tr>
                            ...
                            <td>
                               ...
                               <a href="issue_probook.php?professor_id=<?php echo $row['professor_id']; ?>&book_num=<?php echo $row['book_num']; ?>"style="text-decoration: none; color:white;">Approve</a>
