...
<span><marquee>This is Department Library Automation System. Library opens at 8:00 AM and closes at 8:00 PM.</marquee></span>

<div id="card-home">
  <div class="card-left">
    <img src="logins.jpg" alt="Student Illustration">
  </div>

  <div class="card-right">
    <center class="logo"><h3>Student Login Form</h3></center>
    <form action="" method="post" onsubmit="return validateFunction();">
      ...
      <!--<a class="logo1" href="signup_form.php">Sign Up</a>-->
    </form>
